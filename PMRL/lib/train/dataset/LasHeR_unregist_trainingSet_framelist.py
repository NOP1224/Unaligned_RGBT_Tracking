...
class LasHeR_unregist_trainingSet_framelist(BaseVideoDataset):
    def __init__(self, root=None, dtype='rgbrgb', image_loader=jpeg4py_loader, data_fraction=None, framelist=1, pre_align=False):
        ...
        # Keep LasHeR and LUART on the same pre-alignment policy.
        # MAX_TRANS is an object-size multiplier used only by the synthetic
        # failure branch: max_trans_px = MAX_TRANS * sqrt(bbox_w * bbox_h).
        self.max_trans = 2.0
        self.max_scale = 1.2
        self.min_scale = 0.8
        self.random_offset_prob = 0.1
        self.history_offset_prob = 0.9
        ...
        self.using_align_sample = True
        print(
            "----LasHeR Train Using Align Sample "
