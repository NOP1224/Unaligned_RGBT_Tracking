...
class LasHeR_Unalign(BaseRGBTDataet):
    """
    ...
    """
    def __init__(self, gt_path=f'/data1/Code/jinjiandong/Neuro_Unaligned/eval_tracker/metrics/gt_file/LasHeR_Unalign/annos/',
                 seq_name_path=f"/data1/Code/jinjiandong/Neuro_Unaligned/eval_tracker/metrics/gt_file/LasHeR_Unalign/lashertest.txt") -> None:
